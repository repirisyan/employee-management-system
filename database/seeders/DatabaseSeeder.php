    ...
    public function run(): void
    {
        ...
        $adminEmployee = Employee::firstOrCreate(
            ...
            [
                ...
                'department_id' => Department::where('code', 'SDM')->first()?->id,
                'sub_department_id' => SubDepartment::where('code', 'SDM-DIK')->first()?->id,
                'gender' => 'L',
        ...
        foreach ($sampleEmployees as $empData) {
            ...
            $emp = Employee::firstOrCreate(
                ...
                [
                    ...
                    'department_id' => Department::where('code', $empData['dep_code'])->first()?->id,
                    'sub_department_id' => SubDepartment::where('code', $empData['sub_code'])->first()?->id,
